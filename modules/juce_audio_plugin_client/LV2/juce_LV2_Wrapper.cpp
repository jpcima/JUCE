...
#include "juce_LV2_FileCreator.cpp"
...
public:
          ...
          usingNominalBlockLength (false)
    {
        ...
        lastControlValues.ensureStorageAllocated(params.size());
...
#if ! JUCE_AUDIOPROCESSOR_NO_GUI
/** Returns external UI URI */
static const String& getExternalUiURI()
{
    // JucePlugin_LV2URI might be defined as a function (eg. allowing dynamic URIs based on filename)
    static const String externalUiURI(getPluginURI() + "#ExternalUI");
    return externalUiURI;
}

/** Returns parent UI URI */
static const String& getParentUiURI()
{
    // JucePlugin_LV2URI might be defined as a function (eg. allowing dynamic URIs based on filename)
    static const String parentUiURI(getPluginURI() + "#ParentUI");
    return parentUiURI;
}
#endif

static const LV2_Descriptor JuceLv2Plugin = {
    getPluginURI().toRawUTF8(),
    juceLV2_Instantiate,
    juceLV2_ConnectPort,
    juceLV2_Activate,
    juceLV2_Run,
