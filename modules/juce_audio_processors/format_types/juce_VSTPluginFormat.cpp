                               ...
                               private AsyncUpdater
{
          ...
          bypassParam (new VST2BypassParameter (*this))
    {
        ...
        for (int i = 0; i < vstEffect->numParams; ++i)
        {
            ...
            String label;
            bool isAutomatable = dispatch (26, i, 0, 0, 0) != 0;
                                      ...
                                      int initialBlockSize)
    {
        if (auto* newEffect = constructEffect (newModule))
        {
            ...
            newEffect->dispatcher (newEffect, 22, 0, 0, 0, 0);
    ...
    double getTailLengthSeconds() const override
    {
        ...
        auto tailSize = dispatch (52, 0, 0, 0, 0);
...
private:
    ...
    void openPluginWindow (void* parentWindow)
    {
        ...
        pluginWantsKeys = (dispatch (57, 0, 0, 0, 0) == 0);
